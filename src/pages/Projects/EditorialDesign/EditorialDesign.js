...
const EditorialDesign = props => {
    return (
        <section className={classes.container}>
            <article>
                <iframe src="https://cdn.flipsnack.com/widget/v2/widget.html?hash=cn0xqw23f2" width="100%" height="450px" seamless="seamless" scrolling="no" frameBorder="0" allowFullScreen />
                <div>
                    <h3> CULTURAL RHYTHM </h3>
                    <p>
                        CULTURAL RHYTHM is more than a magazine, it is your companion on an international journey. It is a brand that involves the community, researchers and professionals in different dances and culture to bring you a unique and innovative dance experience at your fingertips. Rhythm, dance, forms, history and culture seen from a new perspective. In each edition, the background and meaning of the most important and curious dances and dances around the world will be explored, motivating users to explore their limits and learn a little more about other cultures.
                    </p>
                </div>
            </article>
            <article>
                <iframe src="https://cdn.flipsnack.com/widget/v2/widget.html?hash=um0xqw23f2" width="100%" height="450px" seamless="seamless" scrolling="no" frameBorder="0" allowFullScreen />
                <div>
                    <h3> BELLIFORTIS </h3>
                    <p>
                        BELLIFORTIS is a magazine dedicated to the dissemination of information on feminist issues. Between its pages it tries to report on what is happening around the world.
                    </p>
                </div>
            </article>
            <article>
                <iframe src="https://cdn.flipsnack.com/widget/v2/widget.html?hash=xnq1e4wilw" width="100%" height="450px" seamless="seamless" scrolling="no" frameBorder="0" allowFullScreen />
                <div>
                    <h3> JIM MCKENZINE </h3>
                    <p>
                        The project consisted in creating a fanzine with a free theme, on occasion it was decided to use this format to publicize different designers. The objective is to give a pocket collection to the new members of the design school of the Dr. José Matías Delgado University. For the first edition, it was decided to present the American illustrator Jim Mckenzie. Among the pages we can find his best-known works and part of his creative process.
                    </p>
                </div>
            </article>
        </section>
